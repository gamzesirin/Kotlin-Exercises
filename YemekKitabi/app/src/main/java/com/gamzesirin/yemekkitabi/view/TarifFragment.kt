...
import com.gamzesirin.yemekkitabi.databinding.FragmentTarifBinding
...
class TarifFragment : Fragment() {
    ...
    override fun onCreateView(
        ...
        _binding = FragmentTarifBinding.inflate(layoutInflater)
    ...
    override fun onViewCreated(view: View, savedInstanceState: Bundle?) {
        ...
        binding.button.setOnClickListener{kaydet(it)}
        binding.button2.setOnClickListener{sil(it)}
